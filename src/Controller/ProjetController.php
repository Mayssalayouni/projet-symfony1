...
class ProjetController extends AbstractController
{
    ...
    public function assignChercheurs($projetId, $chercheurIds): Response
    {
        ...
        $chercheurs = $entityManager->getRepository(Chercheur::class)->findBy(['id' => $chercheurIds]);

        foreach ($chercheurs as $chercheur) {
            $projet->addChercheur($chercheur);
        }
